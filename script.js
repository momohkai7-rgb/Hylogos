/* ===================== Cosmic backdrop (Premium Neon 2D Black Hole) ===================== */
(function backdrop() {
  ...
  // Mathematically projects the disk into the background with lensing warp
  ...
  function drawHole(t) {
    ...
    voidGrad.addColorStop(0.96, `rgba(${COLORS.WHITE}, 0.9)`); // Brilliant plasma rim
    voidGrad.addColorStop(1, "rgba(255,255,255,0)");
    ctx.fillStyle = voidGrad;
    ctx.beginPath(); ctx.arc(cx, cy, r, 0, Math.PI * 2); ctx.fill();

    // Near Side Disk (Foreground)
    ctx.globalCompositeOperation = "lighter";
    drawDisk(time, false);
