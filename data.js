...
const ELEMENTS = {
  ...
  N: { z:7, name:"Nitrogen", shells:[2,5], category:"nonmetal", mass:14.007, stableWeight:true, melt:-210, boil:-196, density:1.251, densityUnit:"g/L", phase:"Gas", en:3.04, theoretical:false, blurb:"Makes up about 78% of the air; essential for DNA." },
  ...
  Ge: { z:32, name:"Germanium", shells:[2,8,18,4], category:"metalloid", mass:72.631, stableWeight:true, melt:938, boil:2833, density:5.323, densityUnit:"g/cm³", phase:"Solid", en:2.01, theoretical:false, blurb:"A metalloid semiconductor used in early transistors." },
  ...
  Ru: { z:44, name:"Ruthenium", shells:[2,8,18,15,1], category:"transition", mass:101.072, stableWeight:true, melt:2334, boil:4150, density:12.45, densityUnit:"g/cm³", phase:"Solid", en:2.2, theoretical:false, blurb:"Used as a hardener for platinum alloys." },
  ...
  Nd: { z:60, name:"Neodymium", shells:[2,8,18,22,8,2], category:"lanthanide", mass:144.242, stableWeight:true, melt:1024, boil:3074, density:7.01, densityUnit:"g/cm³", phase:"Solid", en:1.14, theoretical:false, blurb:"Metal behind the world's strongest permanent magnets." },
  ...
  Eu: { z:63, name:"Europium", shells:[2,8,18,25,8,2], category:"lanthanide", mass:151.964, stableWeight:true, melt:826, boil:1529, density:5.264, densityUnit:"g/cm³", phase:"Solid", en:1.2, theoretical:false, blurb:"Provides the red glow in older screen phosphors." },
  ...
  Dy: { z:66, name:"Dysprosium", shells:[2,8,18,28,8,2], category:"lanthanide", mass:162.5, stableWeight:true, melt:1407, boil:2567, density:8.54, densityUnit:"g/cm³", phase:"Solid", en:1.22, theoretical:false, blurb:"Added to magnets to handle high temperatures." },
  ...
  Er: { z:68, name:"Erbium", shells:[2,8,18,30,8,2], category:"lanthanide", mass:167.259, stableWeight:true, melt:1529, boil:2868, density:9.066, densityUnit:"g/cm³", phase:"Solid", en:1.24, theoretical:false, blurb:"Used to amplify light signals in fiber-optics." },
  ...
  Lu: { z:71, name:"Lutetium", shells:[2,8,18,32,9,2], category:"lanthanide", mass:174.967, stableWeight:true, melt:1652, boil:3402, density:9.841, densityUnit:"g/cm³", phase:"Solid", en:1.27, theoretical:false, blurb:"The last and densest lanthanide element." },
  ...
  Re: { z:75, name:"Rhenium", shells:[2,8,18,32,13,2], category:"transition", mass:186.207, stableWeight:true, melt:3186, boil:5596, density:21.02, densityUnit:"g/cm³", phase:"Solid", en:1.9, theoretical:false, blurb:"Used in superalloys for jet engine turbines." },
  ...
  Ra: { z:88, name:"Radium", shells:[2,8,18,32,18,8,2], category:"alkaline-earth", mass:226, stableWeight:false, melt:960, boil:1737, density:5.5, densityUnit:"g/cm³", phase:"Solid", en:0.9, theoretical:false, blurb:"Used in early self-luminous watch dials." },
  Ac: { z:89, name:"Actinium", shells:[2,8,18,32,18,9,2], category:"actinide", mass:227, stableWeight:false, melt:1227, boil:3227, density:10, densityUnit:"g/cm³", phase:"Solid", en:1.1, theoretical:false, blurb:"Glows blue in the dark from ionizing the air." },
  ...
  Rf: { z:104, name:"Rutherfordium", shells:[2,8,18,32,32,10,2], category:"transition", mass:267, stableWeight:false, melt:2127, boil:5527, density:23.2, densityUnit:"g/cm³", phase:"Solid", en:null, theoretical:true, blurb:"First of the superheavy elements." },
  ...
  Og: { z:118, name:"Oganesson", shells:[2,8,18,32,32,18,8], category:"noble-gas", mass:294, stableWeight:false, melt:null, boil:77, density:4.95, densityUnit:"g/cm³", phase:"Solid", en:null, theoretical:true, blurb:"The final element of the table." },
};

// HARDCODED COLOR LIST FOR EVERY ELEMENT SYMBOL
// Noble Gas = Green, Transition = Sky Blue, Nonmetals = Purple
const ATOM_COLOR = {
  ...
  H: 0xF2F0EA, C: 0xC9C3E0, N: 0x3B6FD9, O: 0xE0483E, P: 0xFF8000, S: 0xE8C93A, Se: 0xC9C3E0,
...
const MOLECULE_BLURBS = {
  ...
  NACL: "Salt.", STEEL: "Iron and Carbon alloy.", BRASS: "Copper and Zinc alloy.",
  H2SO4: "Sulfuric Acid.", AGCL: "Silver Chloride.", C6H12O6: "Glucose."
};
...
const ALLOYS = {
  STEEL: { name: "Steel", atoms: [{ el: "Fe", pos: [0,0,0] }, { el: "Fe", pos: [1,0,0] }, { el: "C", pos: [0.5,0.5,0] }], bonds: [[0,2],[1,2]], blurb: "Mainly Iron and Carbon." },
  BRASS: { name: "Brass", atoms: [{ el: "Cu", pos: [0,0,0] }, { el: "Zn", pos: [1.2,0,0] }], bonds: [[0,1]], blurb: "Copper and Zinc." },
  BRONZE: { name: "Bronze", atoms: [{ el: "Cu", pos: [0,0,0] }, { el: "Sn", pos: [1.2,0,0] }], bonds: [[0,1]], blurb: "Copper and Tin." },
  PEWTER: { name: "Pewter", atoms: [{ el: "Sn", pos: [0,0,0] }, { el: "Sb", pos: [1.2,0,0] }], bonds: [[0,1]], blurb: "Mainly Tin." }
};
