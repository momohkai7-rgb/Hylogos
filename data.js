...
// CATEGORY META COLORS (Used to auto-generate atom colors)
const CATEGORY_META = {
  "nonmetal":        { label: "Nonmetal",               color: "#c9c3e0" },
  "noble-gas":        { label: "Noble Gas",              color: "#00ff7f" }, // GREEN per request
...
ATOM_COLOR.C = 0x444444; // Carbon Override to visible dark grey
...
const MOLECULE_BLURBS = {
  H2O: "Water: The universal solvent essential for life.",
  CO2: "Carbon Dioxide: A greenhouse gas produced by respiration.",
  CH4: "Methane: Simplest hydrocarbon; main component of natural gas.",
  NH3: "Ammonia: Pungent gas used in agricultural fertilizers.",
  O2: "Oxygen Gas: Necessary for aerobic respiration.",
  N2: "Nitrogen Gas: Makes up 78% of Earth's atmosphere.",
  NACL: "Sodium Chloride: Ordinary table salt.",
  CO: "Carbon Monoxide: Colorless, odorless, toxic gas.",
  HCL: "Hydrochloric Acid: Strong acid found in the stomach.",
  HF: "Hydrogen Fluoride: Dangerous acid used to etch glass.",
  O3: "Ozone: Stratospheric layer that absorbs UV radiation.",
  H2S: "Hydrogen Sulfide: Toxic gas that smells of rotten eggs.",
  SO2: "Sulfur Dioxide: Byproduct of coal burning; causes acid rain.",
  NO2: "Nitrogen Dioxide: Air pollutant found in car exhaust.",
  N2O: "Nitrous Oxide: Laughing gas; used as an anesthetic.",
  H2O2: "Hydrogen Peroxide: Common disinfectant and bleach.",
  C2H2: "Acetylene: Fuel used for high-temperature welding.",
  C2H4: "Ethylene: Plant hormone used to ripen fruit.",
  C3H8: "Propane: Common fuel for grills and heating.",
  CH3OH: "Methanol: Wood alcohol; toxic solvent.",
  C2H5OH: "Ethanol: The alcohol in beer and wine.",
  CH3COOH: "Acetic Acid: The active ingredient in vinegar.",
  C6H6: "Benzene: Industrial solvent and known carcinogen.",
  C6H12O6: "Glucose: The primary sugar used by cells for energy.",
  C8H10N4O2: "Caffeine: A central nervous system stimulant.",
  NAHCO3: "Baking Soda: Sodium Bicarbonate; used in cooking.",
  CACO3: "Calcium Carbonate: Found in shells, pearls, and chalk.",
  C3H6O: "Acetone: Key ingredient in nail polish remover.",
  H2SO4: "Sulfuric Acid: Highly corrosive industrial chemical.",
  HNO3: "Nitric Acid: Used in the production of explosives.",
  H3PO4: "Phosphoric Acid: Used in colas for tanginess.",
  CHCL3: "Chloroform: Early anesthetic and industrial solvent.",
  CCL4: "Carbon Tetrachloride: Formerly used in dry cleaning.",
  SIO2: "Silicon Dioxide: The primary component of sand.",
  AL2O3: "Aluminum Oxide: Found in rubies and sapphires.",
  FE2O3: "Iron(III) Oxide: The chemical name for common rust.",
  MGCL2: "Magnesium Chloride: Used for road de-icing.",
  KMNO4: "Potassium Permanganate: Strong oxidizing agent.",
  C9H8O4: "Aspirin: Common drug for pain and fever.",
  C2H6O2: "Ethylene Glycol: Main ingredient in antifreeze.",
  C3H8O3: "Glycerol: Used in cosmetics and food products.",
  CH4N2O: "Urea: Important fertilizer and metabolic waste.",
  NA2CO3: "Washing Soda: Used in water softening and glass making.",
  H3BO3: "Boric Acid: Mild antiseptic and flame retardant.",
  SF6: "Sulfur Hexafluoride: Extremely potent greenhouse gas.",
  CS2: "Carbon Disulfide: Solvent used in cellophane production.",
  H2CO: "Formaldehyde: Used to preserve biological specimens.",
  PH3: "Phosphine: Toxic gas found in planetary atmospheres.",
  SIH4: "Silane: Gas used in the silicon semiconductor industry.",
  N2H4: "Hydrazine: Highly reactive liquid used in rocket fuel."
};
...
const MOLECULES = {
  ...
  H2O2: { name: "Hydrogen peroxide", formula: "H₂O₂", atoms: [{ el: "O", pos: [0.7,0,0] }, { el: "O", pos: [-0.7,0,0] }, { el: "H", pos: [0.8,0.6,0.6] }, { el: "H", pos: [-0.8,0.6,-0.6] }], bonds: [[0,1],[0,2],[1,3]] },
  ...
  C2H4: { name: "Ethylene", formula: "C₂H₄", atoms: [{ el: "C", pos: [0.7,0,0] }, { el: "C", pos: [-0.7,0,0] }, { el: "H", pos: [1.2,0.9,0] }, { el: "H", pos: [1.2,-0.9,0] }, { el: "H", pos: [-1.2,0.9,0] }, { el: "H", pos: [-1.2,-0.9,0] }], bonds: [[0,1],[0,2],[0,3],[1,4],[1,5]] },
  C3H8: { name: "Propane", formula: "C₃H₈", atoms: [{ el: "C", pos: [0,0,0] }, { el: "C", pos: [1.2,0,0] }, { el: "C", pos: [-1.2,0,0] }], bonds: [[0,1],[0,2]] },
  CH3OH: { name: "Methanol", formula: "CH₃OH", atoms: [{ el: "C", pos: [0,0,0] }, { el: "O", pos: [1.1,0,0] }, { el: "H", pos: [-0.6,0.6,0.6] }, { el: "H", pos: [-0.6,-0.6,0.6] }, { el: "H", pos: [-0.6,0,-0.6] }], bonds: [[0,1],[0,2],[0,3],[0,4]] },
  ...
  C6H12O6: { name: "Glucose", formula: "C₆H₁₂O₆", atoms: [{ el: "C", pos: [0,0,0] }, { el: "C", pos: [1.5,0,0] }, { el: "O", pos: [2.1,1.2,0] }, { el: "C", pos: [-0.7,1.2,0] }], bonds: [[0,1],[1,2],[0,3]] },
  C8H10N4O2: { name: "Caffeine", formula: "C₈H₁₀N₄O₂", atoms: [{ el: "C", pos: [0,0,0] }, { el: "N", pos: [1.3,0,0] }, { el: "C", pos: [1.9,1.2,0] }, { el: "O", pos: [3.1,1.2,0] }], bonds: [[0,1],[1,2],[2,3]] },
  H2SO4: { name: "Sulfuric acid", formula: "H₂SO₄", atoms: [{ el: "S", pos: [0,0,0] }, { el: "O", pos: [0,1.5,0] }, { el: "O", pos: [0,-1.5,0] }, { el: "O", pos: [1.5,0,0] }, { el: "O", pos: [-1.5,0,0] }], bonds: [[0,1],[0,2],[0,3],[0,4]] },
  SIO2: { name: "Silicon dioxide", formula: "SiO₂", atoms: [{ el: "Si", pos: [0,0,0] }, { el: "O", pos: [1.6,0,0] }, { el: "O", pos: [-1.6,0,0] }], bonds: [[0,1],[0,2]] },
  AL2O3: { name: "Aluminum oxide", formula: "Al₂O₃", atoms: [{ el: "Al", pos: [1.2,0,0] }, { el: "Al", pos: [-1.2,0,0] }, { el: "O", pos: [0,1.5,0] }], bonds: [[0,2],[1,2]] },
  FE2O3: { name: "Iron(III) oxide", formula: "Fe₂O₃", atoms: [{ el: "Fe", pos: [1.2,0,0] }, { el: "Fe", pos: [-1.2,0,0] }, { el: "O", pos: [0,1.5,0] }], bonds: [[0,2],[1,2]] },
  C9H8O4: { name: "Aspirin", formula: "C₉H₈O₄", atoms: [{ el: "C", pos: [0,0,0] }, { el: "O", pos: [1.2,1.2,0] }, { el: "C", pos: [2.0,0,0] }], bonds: [[0,1],[1,2]] }
};

const ALLOYS = {
  STEEL: { name: "Steel", composition: "Iron (~98%) + Carbon", category: "Ferrous Alloy", blurb: "A strong, versatile alloy of iron and carbon used in construction." },
  ...
  BRONZE: { name: "Bronze", composition: "Copper (~88%) + Tin", category: "Copper Alloy", blurb: "Harder than copper; historically revolutionized tool and weapon making." },
  STAINLESS_STEEL: { name: "Stainless Steel", composition: "Iron + Chromium (~10%) + Nickel", category: "Ferrous Alloy", blurb: "Corrosion-resistant alloy used in cutlery and surgical tools." },
  STERLING_SILVER: { name: "Sterling Silver", composition: "Silver (92.5%) + Copper", category: "Silver Alloy", blurb: "Standard for jewelry; pure silver is too soft for daily use." },
  GOLD_14K: { name: "14k Gold", composition: "Gold (58%) + Silver/Copper", category: "Gold Alloy", blurb: "Durable gold alloy where 14/24 parts are pure gold." },
  NITINOL: { name: "Nitinol", composition: "Nickel + Titanium", category: "Shape-Memory Alloy", blurb: "An alloy that can return to its original shape when heated." },
  MAGNALIUM: { name: "Magnalium", composition: "Aluminium + Magnesium", category: "Lightweight Alloy", blurb: "Strong, lightweight alloy used in aircraft and scientific instruments." },
  DURALUMIN: { name: "Duralumin", composition: "Aluminium + Copper", category: "Lightweight Alloy", blurb: "One of the earliest age-hardened aluminum alloys." },
  PEWTER: { name: "Pewter", composition: "Tin (~90%) + Antimony/Copper", category: "Tin Alloy", blurb: "Malleable metal alloy used for decorative objects and tableware." }
};
