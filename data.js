...
ALLOYS.YELLOW_GOLD = { name:"Yellow gold (18K)", category:"precious", formula:"Au–Ag–Cu", elements:{Au:75.0,Ag:12.5,Cu:12.5}, blurb:"18-karat means 75% pure gold by weight; silver and copper make it hard enough to wear daily." };
ALLOYS.ELECTRUM = { name:"Electrum", category:"precious", formula:"Au–Ag", elements:{Au:70.0,Ag:30.0}, blurb:"A naturally-occurring gold-silver alloy used for some of the very first coins ever minted, in ancient Lydia." };
ALLOYS.NICHROME = { name:"Nichrome", category:"functional", formula:"Ni–Cr", elements:{Ni:80.0,Cr:20.0}, blurb:"Resists oxidation even white-hot, which is why it's the standard wire in toasters and hair dryers." };
ALLOYS.CHROMEL = { name:"Chromel", category:"functional", formula:"Ni–Cr", elements:{Ni:90.0,Cr:10.0}, blurb:"Paired with alumel to form Type K thermocouples, the most common temperature sensor in industry." };
ALLOYS.ALUMEL = { name:"Alumel", category:"functional", formula:"Ni–Al–Mn–Si", elements:{Ni:95.0,Al:2.0,Mn:2.0,Si:1.0}, blurb:"The other half of a Type K thermocouple pair, chosen for a predictable voltage response to heat." };
ALLOYS.MUMETAL = { name:"Mu-Metal", category:"functional", formula:"Ni–Fe–Cu–Mo", elements:{Ni:77.0,Fe:14.0,Cu:5.0,Mo:4.0}, blurb:"Extremely good at redirecting magnetic fields around itself — used to shield sensitive electronics." };
ALLOYS.FERROCHROME = { name:"Ferrochrome", category:"ferrous", formula:"Fe–Cr", elements:{Fe:48.0,Cr:52.0}, blurb:"A bulk feedstock alloy added to molten steel to introduce chromium — the first step toward stainless steel." };
ALLOYS.SILICON_BRONZE = { name:"Silicon Bronze", category:"copper", formula:"Cu–Si–Mn", elements:{Cu:96.0,Si:3.0,Mn:1.0}, blurb:"Highly weldable and corrosion-resistant; used for boat fittings, architectural hardware, and fine art casting." };
ALLOYS.BELL_METAL = { name:"Bell Metal", category:"copper", formula:"Cu–Sn", elements:{Cu:78.0,Sn:22.0}, blurb:"A tin-rich bronze specifically tuned to ring with a clear, resonant tone when cast into bells." };
ALLOYS.SPECULUM_METAL = { name:"Speculum Metal", category:"copper", formula:"Cu–Sn", elements:{Cu:67.0,Sn:33.0}, blurb:"Historically polished into mirrors for early reflecting telescopes, before modern silvered glass." };
ALLOYS.NICKEL_SILVER = { name:"Nickel Silver", category:"copper", formula:"Cu–Ni–Zn", elements:{Cu:60.0,Ni:20.0,Zn:20.0}, blurb:"Contains no actual silver — the nickel just makes the copper-zinc alloy look silvery-white." };
ALLOYS.TYPE_METAL = { name:"Type Metal", category:"functional", formula:"Pb–Sb–Sn", elements:{Pb:82.0,Sb:15.0,Sn:3.0}, blurb:"Cast into individual letters for centuries of printing presses; antimony makes it expand slightly as it cools, sharpening the letterform." };
ALLOYS.ZAMAK = { name:"Zamak", category:"functional", formula:"Zn–Al–Cu", elements:{Zn:95.0,Al:4.0,Cu:1.0}, blurb:"Easy to die-cast into fine detail at low cost — the metal behind most toy cars and door handles." };
ALLOYS.AZ31_MAGNESIUM = { name:"AZ31 Magnesium Alloy", category:"titanium", formula:"Mg–Al–Zn", elements:{Mg:96.0,Al:3.0,Zn:1.0}, blurb:"One of the lightest structural alloys in common use, found in laptop cases and racing wheels." };
ALLOYS.BERYLLIUM_COPPER = { name:"Beryllium Copper", category:"copper", formula:"Cu–Be", elements:{Cu:98.0,Be:2.0}, blurb:"As strong as some steels but non-sparking, so it's used for tools around flammable gases and in precision springs." };
ALLOYS.TUNGSTEN_HEAVY_ALLOY = { name:"Tungsten Heavy Alloy", category:"functional", formula:"W–Ni–Fe", elements:{W:90.0,Ni:7.0,Fe:3.0}, blurb:"Nearly as dense as gold but far cheaper — used as a non-toxic replacement for lead in weights and radiation shielding." };
ALLOYS.PLATINUM_IRIDIUM = { name:"Platinum-Iridium", category:"precious", formula:"Pt–Ir", elements:{Pt:90.0,Ir:10.0}, blurb:"Its extreme dimensional stability made it the material chosen for the international kilogram standard, retired in 2019." };
ALLOYS.FIELDS_METAL = { name:"Field's Metal", category:"low-melt", formula:"Bi–In–Sn", elements:{Bi:32.5,In:51.0,Sn:16.5}, blurb:"A non-toxic, low-melting alloy (no lead or cadmium) that melts in hot water — a safer Wood's metal substitute." };
ALLOYS.ROSES_METAL = { name:"Rose's Metal", category:"low-melt", formula:"Bi–Pb–Sn", elements:{Bi:50.0,Pb:28.0,Sn:22.0}, blurb:"An older low-melting alloy, historically cast into fusible plugs that release pressure if a boiler overheats." };
ALLOYS.GALVALUME = { name:"Galvalume", category:"functional", formula:"Al–Zn–Si", elements:{Al:55.0,Zn:43.4,Si:1.6}, blurb:"A zinc-aluminum coating on steel sheet that combines zinc's sacrificial protection with aluminum's long-term durability." };
ALLOYS.HADFIELD_STEEL = { name:"Hadfield (Manganese) Steel", category:"ferrous", formula:"Fe–Mn–C", elements:{Fe:86.0,Mn:13.0,C:1.0}, blurb:"Work-hardens on impact rather than deforming — used in rock-crusher jaws, rail switches, and safe walls." };
ALLOYS.MARAGING_STEEL = { name:"Maraging Steel", category:"ferrous", formula:"Fe–Ni–Co–Mo", elements:{Fe:68.0,Ni:18.0,Co:9.0,Mo:5.0}, blurb:"Combines very high strength with good toughness by aging rather than quenching; used in rocket casings and tooling." };
ALLOYS.WEATHERING_STEEL = { name:"Weathering Steel (Corten)", category:"ferrous", formula:"Fe–Cu–Cr–Ni–Mn–C–Si", elements:{Fe:95.5,Cu:0.3,Cr:0.8,Ni:0.4,Mn:1.25,C:0.12,Si:1.63}, blurb:"Forms a stable rust patina that protects the metal beneath it, so it's left deliberately unpainted in bridges and sculpture." };
ALLOYS.DAMASCUS_STEEL = { name:"Damascus Steel", category:"ferrous", formula:"Fe–C", elements:{Fe:98.5,C:1.5}, blurb:"Historic pattern-welded steel prized for its distinctive banded surface and reputation for a keen, resilient edge." };
ALLOYS.BILLON = { name:"Billon", category:"precious", formula:"Ag–Cu", elements:{Ag:25.0,Cu:75.0}, blurb:"A low-silver alloy historically used to stretch precious metal further in coinage." };
ALLOYS.SHAKUDO = { name:"Shakudo", category:"precious", formula:"Cu–Au", elements:{Cu:96.0,Au:4.0}, blurb:"A Japanese decorative alloy patinated to a deep blue-black, historically used on sword fittings." };
ALLOYS.COBALT_CHROME = { name:"Cobalt-Chrome (CoCrMo)", category:"functional", formula:"Co–Cr–Mo–Ni–Mn–Si", elements:{Co:63.0,Cr:28.0,Mo:6.0,Ni:1.0,Mn:1.0,Si:1.0}, blurb:"Extremely wear-resistant and biocompatible — the standard alloy for artificial hip and knee joints." };
ALLOYS.SOLDER_INDIUM = { name:"Indium Solder", category:"low-melt", formula:"In–Sn", elements:{In:52.0,Sn:48.0}, blurb:"A low-temperature, very soft solder used to join components that can't tolerate the heat of ordinary solder, like some optics." };
ALLOYS.OSMIRIDIUM = { name:"Osmiridium", category:"functional", formula:"Os–Ir", elements:{Os:50.0,Ir:50.0}, blurb:"Among the hardest and most corrosion-resistant metal combinations known — historically used for durable fountain-pen nib tips." };
...
ALLOYS.PERMALLOY = { name:"Permalloy", category:"functional", formula:"Ni–Fe", elements:{Ni:80.0,Fe:20.0}, blurb:"A highly magnetically permeable alloy used in transformer cores and magnetic shielding for sensitive electronics." };
ALLOYS.SUPERMALLOY = { name:"Supermalloy", category:"functional", formula:"Ni–Fe–Mo", elements:{Ni:79.0,Fe:16.0,Mo:5.0}, blurb:"An even more magnetically permeable cousin of permalloy, developed for the most sensitive magnetic shielding applications." };
ALLOYS.SAMARIUM_COBALT = { name:"Samarium-cobalt magnet", category:"functional", formula:"Co–Sm", elements:{Co:66.0,Sm:34.0}, blurb:"Retains its magnetism at much higher temperatures than neodymium magnets, so it's used in jet engines and motors that run hot." };
ALLOYS.FERRONICKEL = { name:"Ferronickel", category:"ferrous", formula:"Fe–Ni", elements:{Fe:80.0,Ni:20.0}, blurb:"A bulk feedstock alloy smelted straight from nickel ore, added to molten steel as the main source of nickel for stainless steel." };
ALLOYS.COPPER_TUNGSTEN = { name:"Copper-tungsten", category:"functional", formula:"W–Cu", elements:{W:80.0,Cu:20.0}, blurb:"Combines copper's conductivity with tungsten's heat resistance — used in electrical contacts that must survive repeated arcing." };
ALLOYS.SILVER_TUNGSTEN = { name:"Silver-tungsten", category:"functional", formula:"W–Ag", elements:{W:75.0,Ag:25.0}, blurb:"Used in high-current switching contacts, where tungsten resists arc erosion and silver keeps electrical resistance low." };
ALLOYS.PLATINUM_RHODIUM = { name:"Platinum-rhodium", category:"precious", formula:"Pt–Rh", elements:{Pt:87.0,Rh:13.0}, blurb:"The alloy pair behind Type R and Type S thermocouples, prized for stable, accurate readings at very high temperatures." };
ALLOYS.WOOTZ_STEEL = { name:"Wootz steel", category:"ferrous", formula:"Fe–C", elements:{Fe:98.3,C:1.7}, blurb:"An ancient high-carbon steel from India, exported for centuries and worked into the legendary patterns of Damascus blades." };
ALLOYS.GALFAN = { name:"Galfan", category:"functional", formula:"Zn–Al", elements:{Zn:95.0,Al:5.0}, blurb:"A zinc-aluminum coating that outlasts traditional galvanizing, giving steel sheet extra corrosion resistance in harsh environments." };
ALLOYS.WHITE_BRONZE = { name:"White bronze", category:"copper", formula:"Cu–Sn–Zn", elements:{Cu:60.0,Sn:30.0,Zn:10.0}, blurb:"A pale, silvery-toned bronze variant historically used for decorative castings and mirror-bright fittings." };
ALLOYS.RED_BRASS = { name:"Red brass", category:"copper", formula:"Cu–Zn–Sn", elements:{Cu:85.0,Zn:10.0,Sn:5.0}, blurb:"A high-copper brass with a warm reddish hue, valued for corrosion resistance in plumbing fittings and marine hardware." };
ALLOYS.MANGANESE_BRONZE = { name:"Manganese bronze", category:"copper", formula:"Cu–Zn–Mn–Fe", elements:{Cu:58.0,Zn:39.0,Mn:2.0,Fe:1.0}, blurb:"Despite the name it's really a high-strength brass; used for ship propellers and heavy-duty gear blanks." };
ALLOYS.ALUMINUM_BRASS = { name:"Aluminum brass", category:"copper", formula:"Cu–Zn–Al", elements:{Cu:76.0,Zn:22.0,Al:2.0}, blurb:"A small addition of aluminum dramatically improves this brass's resistance to corrosion in seawater condenser tubing." };
ALLOYS.TOMBAC = { name:"Tombac", category:"copper", formula:"Cu–Zn", elements:{Cu:85.0,Zn:15.0}, blurb:"A high-copper brass with a gold-like color, historically used for cheap jewelry and, notably, for the 1943 Belgian franc coin." };
ALLOYS.ARGENTIUM_SILVER = { name:"Argentium silver", category:"precious", formula:"Ag–Cu–Ge", elements:{Ag:93.5,Cu:5.5,Ge:1.0}, blurb:"A modern sterling-silver alternative with added germanium, formulated to resist the tarnishing that plagues ordinary sterling." };
